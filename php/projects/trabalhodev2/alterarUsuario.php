    <!--html da página de alteração da senha-->
...
<body>
    ...
    <!--header/nav da página de alteração de senha-->
    ...
    <!--main e administração de forms da página de alteração de senha-->

    <main>
        <form class="form" action="controlAlterar.php" method="post">
            <h2>Alterar a senha</h2>
                <input type="text" name="login" placeholder="Digite o número do seu login (apenas número)" size="40"/>
                <input type="password" name="senha" placeholder="Digite sua nova senha (apenas número)" size="40" class="senha"/><i class="fa-solid fa-eye eye">Ver senha</i>
                <input type="hidden" name="acaousuarioalterar" value="alterarusuarios"/>
                <input type="submit" name="acaousuarioalterar" value="alterarusuarios"/> <!--botão de login-->
                <input type="submit" name="acaousuarioalterar" value="sairusuarios"/> <!--botão de logout-->
        </form>
    </main>
